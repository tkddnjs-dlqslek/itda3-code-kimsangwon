...
CKPT=${1:-./output/rec_korean_v5_ft_v2/best_accuracy}
INFER_DIR=./inference/rec_korean_v5_ft_v2
ONNX_OUT=/workspace/korean_PP-OCRv5_rec_ft_v2.onnx
...
echo "완료: $ONNX_OUT"
echo "로컬로 내려받아 weights/korean_PP-OCRv5_rec_ft_v2.onnx 로 복사한 뒤"
