...
cd PaddleOCR
ls configs/rec/PP-OCRv5/PP-OCRv5_mobile_rec.yml configs/det/PP-OCRv5/PP-OCRv5_mobile_det.yml \
   ppocr/utils/dict/ppocrv5_dict.txt   # 없으면 태그를 올리거나 main 으로 바꿔야 함
...
echo "완료. 다음: finetune/data 를 이 pod 의 /workspace/data 로 올리고 (rsync/scp),"
